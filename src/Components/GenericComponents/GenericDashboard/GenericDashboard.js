...
const GenericDashboard = ({ isHeaderManu }) => {
        ...
        >
          ...
          >
            ...
            >
              ...
              {/* <p
                  className="font-rubik text-lg md:text-xl text-[#000000] dark:text-[#F5F5F5]"
                >
              ...
              <div className="card-body flex flex-col gap-6">
                      ...
                      return <>
                        <div>
                          ...
                          >
                            ...
                            >
                              <div
                                className={games.value ? `front-bar1 h-2.5 bg-[#1B75BC] rounded-2xl  w-[${games.value}%]` : "front-bar1 h-2.5 bg-[#1B75BC] rounded-2xl w-[0%] "}
                              ></div>
                            </div>
                            <div
                ...
                <div>
                  ...
                  >
                    ...
                    >
                      <div
                        className={"front-bar1 h-2.5 bg-[#1B75BC] rounded-2xl w-[77%] "}
                      ></div>
                    </div>
                    <div
                      className="bar-value1 font-rubik text-base text-[#39434F] dark:text-[#B1B1B1]"
              ...
              <div>
                ...
                <div className="card-body flex flex-col gap-4">
                  ...
                  {/* <div className="flex justify-between items-center">
                    ...
                    <div className="relative">
                      <div
                        className="container2 transition-all duration-300 dark:before:bg-[#212121]"
                      >
                        <div
                          className="container-value2 transition-all duration-300 bg-gradient-to-r from-[#F53C3C] to-[#F5AB3C] bg-clip-text text-transparent"
                        >
                          0%
                        </div>
                      </div>
                  ...
                  <div className="flex justify-between items-center">
                    ...
                    <div className="relative">
                      <div
                        className="container3 transition-all duration-300 dark:before:bg-[#212121]"
                      >
                        <div
                          className="container-value3 transition-all duration-300 bg-gradient-to-r from-[#F53C3C] to-[#F5AB3C] bg-clip-text text-transparent"
                        >
                          0%
                        </div>
                      </div>
                  ...
                  <div className="flex justify-between items-center">
                    ...
                    <div className="relative">
                      <div
                        className="container4 transition-all duration-300 dark:before:bg-[#212121]"
                      >
                        <div
                          className="container-value4 transition-all duration-300 bg-gradient-to-r from-[#F53C3C] to-[#F5AB3C] bg-clip-text text-transparent"
                        >
                          0%
                        </div>
                      </div>
                  ...
                  <div className="flex justify-between items-center">
                    ...
                    <div className="relative">
                      <div
                        className="container5 transition-all duration-300 dark:before:bg-[#212121]"
                      >
                        <div
                          className="container-value5 transition-all duration-300 bg-gradient-to-r from-[#F53C3C] to-[#F5AB3C] bg-clip-text text-transparent"
                        >
                          0%
                        </div>
                      </div>
