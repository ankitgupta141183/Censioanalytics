...
const UpgradeSideBar = ({ isHeaderManu}) => {
	...
	return (
		<>
			...
			>
				<div>
					<ul className="py-4">
						<li className={`${sidebarActive === '/upgrade-dashboard' ? 'reletive bg-[#CCE0F0] font-medium dark:bg-[#B1B1B133] transition-all duration-300' : ''}`}>
							<Link to={'/upgrade-dashboard'} className="flex items-center py-3 gap-3"  >
								{
									sidebarActive === '/upgrade-dashboard' && <div
						...
						<li className={`${sidebarActive === '/games-survey' ||
							sidebarActive === Paths.upgradeSurveyQuestions ||
							sidebarActive === Paths.upgradeDemographicsQuestions ||
							sidebarActive === Paths.UpgradeFeedbackQuestions ||
							sidebarActive === Paths.upgradeIntroduction ?
							'reletive bg-[#CCE0F0] font-medium dark:bg-[#B1B1B133] transition-all duration-300' : ''}`}>
							<Link to={'/games-survey'} className="py-3 flex items-center gap-3"  >
								{
									(sidebarActive === '/games-survey' || sidebarActive === Paths.upgradeSurveyQuestions || sidebarActive === Paths.UpgradeFeedbackQuestions || sidebarActive === Paths.upgradeIntroduction) && <div
										className="absolute left-0 rounded-full w-1.5 h-8 bg-[#1B75BC] dark:bg-[#FFFFFF]"
									>	</div>
								}
								<img
						...
						<li className={`${sidebarActive === '/schedule' ? 'reletive bg-[#CCE0F0] font-medium dark:bg-[#B1B1B133] transition-all duration-300' : ''}`}>
							<Link to={'/schedule'} className="py-3 flex items-center gap-3" href="./schedule.html">
								{
									sidebarActive === '/schedule' && <div
										className="absolute left-0 rounded-full w-1.5 h-8 bg-[#1B75BC] dark:bg-[#FFFFFF]"
									>	</div>
								}
								<img
						...
						<li className={`${gamesReportIsActiveRoute.includes(sidebarActive)
							? 'reletive bg-[#CCE0F0] font-medium dark:bg-[#B1B1B133] transition-all duration-300' : ''}`}>
							<Link to={'/reports'} className="py-3 flex items-center gap-3" href="./reports.html">
								{
						...
						<li
							...
							className={`${sidebarActive === '/advisors-courses' ? 'reletive bg-[#CCE0F0] font-medium dark:bg-[#B1B1B133] transition-all duration-300' : ''}`}
						>
							<Link to={'/advisors-courses'} className="py-3 flex items-center gap-3" >
								{
									sidebarActive === '/advisors-courses' && <div
										className="absolute left-0 rounded-full w-1.5 h-8 bg-[#1B75BC] dark:bg-[#FFFFFF]"
									></div>
								}
						...
						<li
							// className="reletive bg-[#CCE0F0] font-medium dark:bg-[#B1B1B133] transition-all duration-300"
							className={`${sidebarActive === Paths.UpgradeContactUs ? 'reletive bg-[#CCE0F0] font-medium dark:bg-[#B1B1B133] transition-all duration-300' : ''}`}
						>
							<Link to={Paths.UpgradeContactUs} className="py-3 flex items-center gap-3" >
								{
									sidebarActive === Paths.UpgradeContactUs && <div
										className="absolute left-0 rounded-full w-1.5 h-8 bg-[#1B75BC] dark:bg-[#FFFFFF]"
									></div>
								}
